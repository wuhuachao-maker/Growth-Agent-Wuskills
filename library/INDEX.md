...
| 爆款机制 | `cases/爆款标题案例库.md` | 联网挖掘 + 真实 A/B 案例 | 2026-08-22 | 🟢 初始登记 |
| 概念口径 | `concepts/内容获客高频概念词典.md` | 内部沉淀 | 2026-08-22 | 🟢 初始登记 |
...
6. **巡检自动化**：`node bridge/check_library.mjs` 自动扫描 `library/` 与 `skills/*/references/` 下各文件的「最后更新」日期——超 90 天报 🟡、超 180 天报 🔴、缺日期报 ⚪；已接入 CI（报告不阻断提交）。日期字段约定：文件开头 `> 最后更新：YYYY-MM-DD`（或 frontmatter `updated:`）。**2026-08-22 为初始登记日**，部分文件真实更新时间待人工核实后修正。
